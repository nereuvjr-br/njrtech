...
export function Examples() {
  return (
    <section id="examples" className="w-full bg-background py-16 sm:py-20 lg:py-24">
      <div className="container px-4 md:px-6">
        ...
        <div className="mx-auto grid gap-6 py-12 sm:grid-cols-2 lg:grid-cols-4">
          {exampleProjects.map((project) => {
            ...
            return (
              <Card key={project.id} className="group overflow-hidden rounded-lg">
                <CardContent className="relative p-0">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/50 p-4 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
